...
proc create_root_design { parentCell } {
  ...
  set Buzzer_AXI_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:Buzzer_AXI:4 Buzzer_AXI_0 ]

  # Create instance: RAM_FREC_0, and set properties
  set block_name RAM_FREC
  set block_cell_name RAM_FREC_0
  if { [catch {set RAM_FREC_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $RAM_FREC_0 eq "" } {
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M04_AXI [get_bd_intf_pins Buzzer_AXI_0/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M04_AXI]

  # Create port connections
  connect_bd_net -net Buzzer_AXI_0_BUZZER_PWM [get_bd_ports BUZZER_PWM] [get_bd_pins Buzzer_AXI_0/BUZZER_PWM]
  connect_bd_net -net Buzzer_AXI_0_LED_R [get_bd_ports LED_R] [get_bd_pins Buzzer_AXI_0/LED_R]
  connect_bd_net -net RAM_FREC_0_frecuencia [get_bd_pins Buzzer_AXI_0/Frecuencia] [get_bd_pins RAM_FREC_0/frecuencia]
  ...
  connect_bd_net -net clk_125MHz_1 [get_bd_ports clk] [get_bd_pins Buzzer_AXI_0/clk] [get_bd_pins RAM_FREC_0/clk]
  ...
  connect_bd_net -net rst_ps7_0_50M_peripheral_reset [get_bd_pins RAM_FREC_0/rst] [get_bd_pins rst_ps7_0_50M/peripheral_reset]
