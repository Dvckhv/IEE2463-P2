...
void GUI_Mover_tanque(int X, int prev_X){
	//Tankesito
	GUI_DrawRectangle(prev_X,67,prev_X+14,78,GUI_BACKGROUND, DRAW_FULL, DOT_PIXEL_1X1);

	GUI_DrawRectangle(X,70,X+14,78,RED, DRAW_FULL, DOT_PIXEL_1X1);
	GUI_DrawRectangle(X+6,67,X+8,70,RED, DRAW_FULL, DOT_PIXEL_1X1);

	GUI_DrawPoint(X,70, GUI_BACKGROUND, DOT_PIXEL_1X1, DRAW_FULL);
	GUI_DrawPoint(X+14,70, GUI_BACKGROUND, DOT_PIXEL_1X1, DRAW_FULL);
	GUI_DrawPoint(X+6,67, GUI_BACKGROUND, DOT_PIXEL_1X1, DRAW_FULL);
	GUI_DrawPoint(X+8,67, GUI_BACKGROUND, DOT_PIXEL_1X1, DRAW_FULL);
}
