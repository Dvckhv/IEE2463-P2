...
parameter:
			...
			Filled : Whether it is filled--- 1 solid 0 is empty
********************************************************************************/
...
void GUI_Alien_A(int X, int Y){
	//alien paras
	GUI_DrawRectangle(X,Y,X+10,Y+8,GREEN, DRAW_FULL, DOT_PIXEL_1X1);  //x cuenta todos pero en y es uno menos

	GUI_DrawPoint(X+3,Y+3, GUI_BACKGROUND, DOT_PIXEL_1X1, DRAW_FULL);
	GUI_DrawPoint(X+7,Y+3, GUI_BACKGROUND, DOT_PIXEL_1X1, DRAW_FULL);
	GUI_DrawPoint(X+5,Y+7, GUI_BACKGROUND, DOT_PIXEL_1X1, DRAW_FULL);
	GUI_DrawPoint(X+2,Y+1, GUI_BACKGROUND, DOT_PIXEL_1X1, DRAW_FULL);
	GUI_DrawPoint(X+8,Y+1, GUI_BACKGROUND, DOT_PIXEL_1X1, DRAW_FULL);

	GUI_DrawLine(X,Y,X,Y+4,GUI_BACKGROUND,LINE_SOLID,DOT_PIXEL_1X1);
	GUI_DrawLine(X+1,Y,X+1,Y+3,GUI_BACKGROUND,LINE_SOLID,DOT_PIXEL_1X1);
	GUI_DrawLine(X+9,Y,X+9,Y+3,GUI_BACKGROUND,LINE_SOLID,DOT_PIXEL_1X1);
	GUI_DrawLine(X+10,Y,X+10,Y+4,GUI_BACKGROUND,LINE_SOLID,DOT_PIXEL_1X1);
	GUI_DrawLine(X+3,Y,X+7,Y,GUI_BACKGROUND,LINE_SOLID,DOT_PIXEL_1X1);
	GUI_DrawLine(X+4,Y+1,X+6,Y+1,GUI_BACKGROUND,LINE_SOLID,DOT_PIXEL_1X1);
	GUI_DrawLine(X,Y+7,X+2,Y+7,GUI_BACKGROUND,LINE_SOLID,DOT_PIXEL_1X1);
	GUI_DrawLine(X+8,Y+7,X+10,Y+7,GUI_BACKGROUND,LINE_SOLID,DOT_PIXEL_1X1);
	GUI_DrawLine(X+1,Y+5,X+1,Y+6,GUI_BACKGROUND,LINE_SOLID,DOT_PIXEL_1X1);
	GUI_DrawLine(X+9,Y+5,X+9,Y+6,GUI_BACKGROUND,LINE_SOLID,DOT_PIXEL_1X1);
	GUI_DrawLine(X+3,Y+6,X+7,Y+6,GUI_BACKGROUND,LINE_SOLID,DOT_PIXEL_1X1);
}

void GUI_tanque(int X, int Y){
	//Tankesito
	GUI_DrawRectangle(X,Y+3,X+14,Y+11,RED, DRAW_FULL, DOT_PIXEL_1X1);
	GUI_DrawRectangle(X+6,Y,X+8,Y+3,RED, DRAW_FULL, DOT_PIXEL_1X1);

	GUI_DrawPoint(X,Y+3, GUI_BACKGROUND, DOT_PIXEL_1X1, DRAW_FULL);
	GUI_DrawPoint(X+14,Y+3, GUI_BACKGROUND, DOT_PIXEL_1X1, DRAW_FULL);
	GUI_DrawPoint(X+6,Y, GUI_BACKGROUND, DOT_PIXEL_1X1, DRAW_FULL);
	GUI_DrawPoint(X+8,Y, GUI_BACKGROUND, DOT_PIXEL_1X1, DRAW_FULL);
}
...
void GUI_mover_tanque(int X, int prev_X, int Y){
	...
	if (X - prev_X > 0){
		d = X - prev_X;
		GUI_DrawRectangle(prev_X+14,Y+3,prev_X+13+d,Y+4,RED, DRAW_FULL, DOT_PIXEL_1X1);
		GUI_DrawRectangle(prev_X+15,Y+4,prev_X+14+d,Y+11,RED, DRAW_FULL, DOT_PIXEL_1X1);
		GUI_DrawRectangle(prev_X+8,Y,prev_X+7+d,Y+1,RED, DRAW_FULL, DOT_PIXEL_1X1);
		GUI_DrawRectangle(prev_X+9,Y+1,prev_X+8+d,Y+3,RED, DRAW_FULL, DOT_PIXEL_1X1);

		GUI_DrawRectangle(prev_X+1,Y+3,prev_X+d,Y+4,GUI_BACKGROUND, DRAW_FULL, DOT_PIXEL_1X1);
		GUI_DrawRectangle(prev_X,Y+4,prev_X-1+d,Y+11,GUI_BACKGROUND, DRAW_FULL, DOT_PIXEL_1X1);
		GUI_DrawRectangle(prev_X+7,Y,prev_X+6+d,Y+1,GUI_BACKGROUND, DRAW_FULL, DOT_PIXEL_1X1);
		GUI_DrawRectangle(prev_X+6,Y+1,prev_X+5+d,Y+3,GUI_BACKGROUND, DRAW_FULL, DOT_PIXEL_1X1);
	}
	else if (X - prev_X < 0){
		d = prev_X - X;

		GUI_DrawRectangle(prev_X,Y+3,prev_X+1-d,Y+4,RED, DRAW_FULL, DOT_PIXEL_1X1);
		GUI_DrawRectangle(prev_X-1,Y+4,prev_X-d,Y+11,RED, DRAW_FULL, DOT_PIXEL_1X1);
		GUI_DrawRectangle(prev_X+6,Y,prev_X+7-d,Y+1,RED, DRAW_FULL, DOT_PIXEL_1X1);
		GUI_DrawRectangle(prev_X+5,Y+1,prev_X+6-d,Y+3,RED, DRAW_FULL, DOT_PIXEL_1X1);

		GUI_DrawRectangle(prev_X+13,Y+3,prev_X+14-d,Y+4,GUI_BACKGROUND, DRAW_FULL, DOT_PIXEL_1X1);
		GUI_DrawRectangle(prev_X+14,Y+4,prev_X+15-d,Y+11,GUI_BACKGROUND, DRAW_FULL, DOT_PIXEL_1X1);
		GUI_DrawRectangle(prev_X+7,Y,prev_X+8-d,Y+1,GUI_BACKGROUND, DRAW_FULL, DOT_PIXEL_1X1);
		GUI_DrawRectangle(prev_X+8,Y+1,prev_X+9-d,Y+3,GUI_BACKGROUND, DRAW_FULL, DOT_PIXEL_1X1);
	}
